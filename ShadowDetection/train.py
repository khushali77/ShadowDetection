...
#my_loader = DataLoader(data, batch_size=8, shuffle=True, )

#train_loader = DataLoader(train_set, batch_size=6, num_workers=0, shuffle=False, collate_fn=collate_fn)
...
def single_gpu_train():
    ...
    for epoch in range(40):
        ...
        if epoch_loss<=min:
            ...
            torch.save(net.state_dict(), './model/Merged_data_SBU_ISTD.PTH')
